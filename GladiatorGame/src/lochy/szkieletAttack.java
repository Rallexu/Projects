...
import static lochy.lochy.Skeleton;
 ...
 * @author allan
 */
public class szkieletAttack extends javax.swing.JFrame {

       
  int valueGlad=object_character.zycie;
  int valueSkeleton=Skeleton.potworZycie;
 
  
    String champInt=String.valueOf(object_character.zycie);
    String skeletonInt=String.valueOf(Skeleton.potworZycie);
  
    public szkieletAttack() {
        initComponents();
            
   champBar.setString(champInt);
   skeletonBa.setString(skeletonInt);
   ...
   //gladiatorProgress.setMaximum(Rall.zycie);
    ...
    skeletonBa.setValue(Skeleton.potworZycie);
    }
    ...
    private void initComponents() {
        ...
        skeletonLab = new javax.swing.JLabel();
        skeletonBa = new javax.swing.JProgressBar();
        skeletonR = new javax.swing.JTextField();
        ...
        skeletonPanel.setBackground(new java.awt.Color(91, 104, 94));
        skeletonPanel.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, null, java.awt.Color.black, java.awt.Color.gray, null));
        skeletonPanel.setForeground(new java.awt.Color(91, 109, 94));

        skeletonLab.setForeground(new java.awt.Color(91, 109, 94));
        skeletonLab.setIcon(new javax.swing.ImageIcon("/Users/allan/Desktop/gallery_photos_game/skelet.jpg")); // NOI18N
        skeletonLab.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true));
        skeletonLab.setDoubleBuffered(true);

        skeletonBa.setStringPainted(true);

        skeletonR.setEditable(false);
        skeletonR.setFont(new java.awt.Font("Papyrus", 0, 13)); // NOI18N
        skeletonR.setForeground(new java.awt.Color(91, 109, 94));
        skeletonR.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        skeletonR.setText("Szkielet");
        skeletonR.setCaretColor(new java.awt.Color(91, 109, 94));
        ...
        skeletonPanelLayout.setHorizontalGroup(
            ...
            .addGroup(skeletonPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(skeletonLab, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addComponent(skeletonR)
            .addComponent(skeletonBa, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        skeletonPanelLayout.setVerticalGroup(
            skeletonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(skeletonPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(skeletonLab, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(skeletonR, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(skeletonBa, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        getContentPane().add(skeletonPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 80, -1, 320));
        ...
        backgroundSkeleton.setIcon(new javax.swing.ImageIcon("/Users/allan/Desktop/gallery_photos_game/lochy_tlo.jpg")); // NOI18N
    ...
    private void attackButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_attackButActionPerformed
        ...
        if(Skeleton.potworZycie > 0 && object_character.zycie > 0){
            if(Skeleton.potworZycie == 0 || object_character.zycie==0){
                System.out.println("MARTWI");
            }
            else{
                 object_character.atak(Skeleton);
                 Skeleton.atakPotwor(object_character);            
                 valueGlad=object_character.zycie;
                 valueSkeleton=Skeleton.potworZycie;
                 champInt=String.valueOf(object_character.zycie); 
                 skeletonInt=String.valueOf(Skeleton.potworZycie);
     
     
                        champBar.setValue(valueGlad);
                        skeletonBa.setValue(valueSkeleton);
                        champBar.setString(champInt);
                        skeletonBa.setString(skeletonInt);
                }
        }
         if(Skeleton.potworZycie==0){unlocking(1);}
         if(object_character.zycie<=0){Skeleton.potworZycie=Skeleton.potworZycieWartownik;}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(szkieletAttack.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JProgressBar skeletonBa;
    private javax.swing.JLabel skeletonLab;
    private javax.swing.JPanel skeletonPanel;
    private javax.swing.JTextField skeletonR;
